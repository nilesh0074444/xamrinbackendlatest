...
// y-M-d   MMMM d, y   MMMM d,y   y-MMMM-d   d-MMMM-y  MMMM d
...
function parseDate(val) {
	...
	generalFormats=new Array('y-M-d','MMMM d, y','MMMM d,y','y-MMMM-d','d-MMMM-y','MMMM d');
	monthFirst=new Array('M/d/y','M-d-y','M.d.y','MMMM-d','M/d','M-d');
	dateFirst =new Array('d/M/y','d-M-y','d.M.y','d-MMMM','d/M','d-M');
...
function addTime(date1,format,f) {
