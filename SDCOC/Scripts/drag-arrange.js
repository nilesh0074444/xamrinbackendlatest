    ...
    function dragEndHandler(e) {
      if (dragging) {
        ...
        dragElement.style.visibility = 'visible';
          //alert($(this));
        //alert(dragElement.id.split('_')[1]);
          //alert($("#totalsectionsproducts_" + dragElement.id.split('_')[1]).val());
        $("#dargsectionname").val("");
        $("#dargsectionname").val(dragElement.id.split('_')[1]);
